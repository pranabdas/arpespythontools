...
def k_conv(data, energy, angle, fermi_energy) :
    ...
    This function requires intensity data as two dimensional array (x-dimenstion is along energy, and y-dimension along angle), and energy and angle as one dimensional array. Also we need to provide the position of Fermi energy.

    Then the funtion returns intensity in k-space, binding energy and k vector.
    '''
    import numpy as np
