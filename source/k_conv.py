...
def k_conv(data, energy, angle, fermi_energy) :
    ...
    This function requires intensity data as two dimensional array (x-dimension is along energy, and y-dimension along angle), and energy and angle as one dimensional array. Also we need to provide the position of Fermi energy.
